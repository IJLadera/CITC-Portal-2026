    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('ADMIN', 'Admin'), ('AUDITOR', 'Auditor'), ('CHAIRPERSON', 'Chairperson'), ('DEAN', 'Dean'), ('BAYANIHAN_TEACHER', 'Bayanihan Teacher'), ('BAYANIHAN_LEADER', 'Bayanihan Leader')], max_length=50, unique=True)),
