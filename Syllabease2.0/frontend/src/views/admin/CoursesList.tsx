...
export default function CoursePage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        const [coursesRes, deptRes, curriculaRes] = await Promise.all([
          api.get("/academics/courses/", { params }),
          api.get("/academics/departments/", { params: { role, all: true } }),
          api.get("/academics/curricula/", { params: { role, all: true } }),
        ]);
  ...
  }, [currentPage, selectedYearLevel, selectedDept, selectedSemester, searchTerm]);
  ...
  return (
    <div className="flex-1 flex flex-col p-4"> 
      ...
      <Modal dismissible show={openModal} onClose={() => setOpenModal(false)}>
        <ModalHeader>{editMode ? "Edit Course" : "Create Course"}</ModalHeader>
        <ModalBody>
          <div className="space-y-4">
            ...
            <div>
              ...
              <TextInput
                ...
                onChange={(e) =>
                  setFormData({ ...formData, course_pre_req: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <TextInput
                ...
                onChange={(e) =>
                  setFormData({ ...formData, course_co_req: e.target.value })
                }
              />
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-[#007BFF] text-white text-sm w-full border border-radius-sm">
                    ...
                    <th className="p-2">Units (Lec/Lab)</th>
                    <th className="p-2">Credit</th>
                    <th className="p-2">Hours (Lec/Lab)</th> 
