...
export default function DeadlinePage() {
  ...
  const fetchColleges = async () => {
    try {
      const res = await api.get("/academics/colleges/");
  ...
  const handleOpenModal = (deadline?: Deadline) => {
    ...
    if (deadline) {
      ...
      setFormData({
        ...
        college_id: deadline.college.id,
      });
    } else {
      setEditMode(false);
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, college_id: Number(e.target.value) })
                }
                required
              >
              ...
              {formErrors.college_id && (
                <p className="text-red-500 text-sm mt-1">{formErrors.college_id}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <Label htmlFor="tos_midterm_deadline">TOS Midterm Deadline *</Label>
                <TextInput
            ...
            <table className="w-full border-collapse border border-gray-300 text-sm text-center">
              <thead>
                <tr className="bg-[#007BFF] text-white">
                  <th className="p-2 w-[23%]">College</th>
                  <th className="p-2 w-[9%]">School Year</th>
                  <th className="p-2 w-[8%]">Semester</th>
                  <th className="p-2 w-[17%]">Syllabus</th>
                  <th className="p-2 w-[17%]">TOS Midterm</th>
                  <th className="p-2 w-[17%]">TOS Final</th>
