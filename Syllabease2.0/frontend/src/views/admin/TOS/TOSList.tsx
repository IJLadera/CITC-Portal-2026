  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        console.error("Failed to load TOS or approved syllabis", err); 
      ...
      <main className="p-4 mt-5 flex justify-center">
        <div className="p-6 shadow bg-white rounded-lg border border-gray-200 w-full max-w-6xl">
          <div className="flex items-center justify-between mb-6">
            <h1 className="font-bold text-3xl text-[#201B50] mb-4 text-left">
              List of TOS
            </h1> 
            ...
            <div ref={menuRef} className="relative">
              ...
              >
                <HiDotsVertical
                  size={22}
                  className="text-gray-500 group-hover:text-[#201B50] transition-colors"
                />
              </button>

              {/* Dropdown Menu */}
              {openSmallMenu && (
                <div className="absolute right-0 mt-2 w-55 bg-white border border-gray-200 rounded-xl shadow-lg z-10 animate-fadeIn">
                  <ul className="py-1 text-sm text-gray-700"> 
                    <li>
                      <button
                        className="flex gap-2 w-full items-center justify-left text-left px-4 py-2 hover:bg-gray-100 transition-colors"
                        onClick={() => navigate("tos-template")}
                      >
                        <GrTemplate size={17} color="blue"/> 
                        <h1>TOS Template</h1>
                      </button>
                    </li>   
                  </ul>
          ...
          <Modal show={showSyllabiModal} onClose={() => setShowSyllabiModal(false)} size="lg">
          ...
          <div className="flex flex-nowrap gap-2 items-center justify-between overflow-x-auto mb-6 px-2 scrollbar-hide">
            ...
            >
              ...
              <option value="Requires Revisios">Requires Revision</option>
          ...
          <div className="flex-1 overflow-y-auto relative">
            ...
            {openMenuId !== null && menuCoords && (
              ...
              >
                <div className="py-1">
                  <button
                    onClick={() => navigate(`${openMenuId}/view`)}
                    className="w-full text-left px-4 py-2 text-black-600 hover:bg-gray-100 flex items-center gap-2"
                  > 
                    View TOS
                  </button> 
                  <button
                    onClick={() => navigate(`/${activeRole}/tos/${openMenuId}/override-date`)}
                    className="w-full text-left px-4 py-2 text-black-600 hover:bg-gray-100 flex items-center gap-2"
                  > 
                    Override TOS
                  </button>  
