...
export default function TOSList() { 
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        setError("Failed to load TOS or approved syllabi");
        toast.error("Failed to load TOS or approved syllabi")
      } finally {
  ...
  }, [role, currentPage, selectedYearLevel, selectedProgram, selectedSemester, selectedYear, searchTerm]); 
    ...
    <div className="flex-1 flex flex-col">
      ...
      <main className="p-4 mt-5  flex justify-center">
        <div className="p-6 shadow bg-white rounded-lg border border-gray-200 w-full max-w-6xl">
          ...
          {/* Filter Section */}
          <div className="flex flex-wrap gap-4 items-center justify-around mb-6"> 
            {/* Search */}
            <TextInput
              type="text"
