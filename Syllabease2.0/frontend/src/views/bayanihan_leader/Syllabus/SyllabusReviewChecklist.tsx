...
export default function SyllabusReviewChecklist() {
  ...
  const handleChange = (id: number, field: "response" | "remarks", value: any) => {
   ...
   const handleReview = async (decision: "approve" | "reject") => {
    ...
    try {
      if (decision === "approve") {
        // Only send decision (backend auto-fills YES for all items)
        await api.post(`/syllabi/${syllabusId}/review-syllabus-chair/?role=${role}`, {
          decision: "approve",
        });
      } else {
        // Build arrays for reject case
        ...
        <div className="p-4 h-[92%] flex flex-col mb-4">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="ml-auto px-3 py-1 rounded bg-gray-200 hover:bg-gray-300 text-gray-700"
            >
              <FaTimes />
            </button>
          </div>
                ...
                <td colSpan={2} className="w-[10/12] align-top border-black">
                    ...
                    <tbody>
                      <tr>
                          <td className="border-2 border-solid border-black font-medium text-left px-4 w-1/2 relative">
                            Semester/Year: {syllabus.course.course_semester} Semester -  SY{syllabus.bayanihan_group.school_year}<br />
                  ...
                  <div className="grid grid-cols-3 m-3">
                        ...
                        .map((instructor, idx) => (
                          <div className="mt-5" key={idx}>
                            <div className="flex justify-center">
                              ...
                              <img
                                  src={`/assets/signatures/${instructor.user.signature}`}
                    ...
                    <div>
                      ...
                      <div className="flex justify-center">Department Chair, {syllabus.program.department.department_code}</div>
                    </div>
                    <div>
                      ...
                      <div className="flex justify-center">Dean, {syllabus.college.college_code}</div>
                    </div>
                  </div>
                </td>
            </tr>
