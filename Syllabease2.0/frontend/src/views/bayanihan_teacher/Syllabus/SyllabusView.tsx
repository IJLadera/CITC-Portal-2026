...
export default function SyllabusView() { 
  ...
  return (
    <div className="font-thin min-h-screen my-14"> 
      ...
      <button
        type="button"
        onClick={() => navigate("/bayanihan_teacher/syllabus/")}
          ...
          switch (syllabus.status) {
            ...
            case "Draft": 
              return (
                ...
                >
                  <p className="mb-2">
                    <strong>Notice:</strong> This syllabus is currently in <strong>Draft</strong> status.
                    You may comment and submit it once you are ready for Chairperson review.
                  </p>
                </div>
              );
            ...
            case "Requires Revision":
              return (
                ...
                >
                  <p className="mb-2">
                    <strong>Notice:</strong> Revisions are required before this syllabus can proceed. 
                  </p> 
                </div>
              );
          }
      ...
      <div className="mx-auto mt-6 w-11/12 max-w-[1500px] border-[3px] border-black bg-white font-serif text-sm p-4 px-24 relative">
        ...
        <table className="mt-2 mx-auto border-2 border-solid w-full max-w-full font-serif text-sm bg-white">
            ...
            <tr>
                ...
                {/* Program Outcomes */}
                <div className="mb-8 border-black relative">
