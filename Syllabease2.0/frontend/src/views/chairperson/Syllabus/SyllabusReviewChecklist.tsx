...
export default function SyllabusReviewChecklist() {
  ...
  return (
    <div className="font-thin min-h-screen my-14">
      ...
      <div
        className={`fixed top-16 right-0 bottom-0 w-[60%] md:w-[40%] bg-white shadow-xl border-l transform transition-transform duration-300 z-40 ${
          open ? "translate-x-0" : "translate-x-full"
        }`}
      >
        <div className="p-4 flex flex-col h-full mb-4">
