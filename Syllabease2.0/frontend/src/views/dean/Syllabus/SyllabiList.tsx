...
export default function SyllabiList() {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        const [syllabiRes, deptRes] = await Promise.all([ 
          api.get(`/syllabi/`, { params }),
          api.get(`/academics/departments/`, { params: { role: role, all: true } })
        ]); 
        ...
        if (err.response && err.response.data) {
          ...
          toast.error("Error fetching Syllabi. Please try again later.");
        }
  ...
  }, [role, currentPage, selectedDept, selectedYearLevel, selectedSemester, selectedYear, selectedStatus, searchTerm]);
        ...
        <div className="p-6 shadow bg-white rounded-lg border border-gray-200 w-full max-w-6xl flex flex-col">
          ...
          <div className="flex flex-nowrap gap-2 items-center justify-between overflow-x-auto mb-6 px-2 scrollbar-hide">
            ...
            >
              ...
              <option value="Approved by Chai">Approved by Chair</option>
