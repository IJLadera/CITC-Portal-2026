            ...
            <div className="h-full px-3 py-4 overflow-y-auto">
                ...
                <ul className="space-y-2 font-medium">
                    <li onClick={() => navigate('/')}>
                        ...
                        <RiHomeLine className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white" />
                    ...
                    <li onClick={() => navigate('lms')}>
                        <a href="#" className="flex items-center p-2 text-white rounded-lg dark:text-white dark:hover:bg-gray-700 group">
                        <PiBooksThin className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white" />
